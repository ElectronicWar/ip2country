...
;#                                                                                        #
;#  Version: ver.1.03  -  released on 26 Sept 2010                                        #
...
;#                                                                                        #
;# //load -rs1 $+(",$nofile($mircexe),ip2country\ip2country.ver.1.03.mrc,")               #
;#                                                                                        #
;#  Otherwise, open the Remote Script Area ( Tools | Script Editor) and                   #
;#  click on File | Load, and find the file ip2country.ver.1.03.mrc                       #
;#                                                                                        #
...
;### This alias is Still under development even on release of ver 1.03
ALIAS ip2c.var { 
